...
// Sample vendor data for suspended vendors
const initialVendors: Vendor[] = [
  ...
  { 
    ...
    businessEmail: 'info@gadgetworld.com',
    businessPhone: '+1 (555) 321-0987',
  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Suspended Vendors</h1>
          <p className="mt-2 text-sm text-gray-700">A list of all suspended vendors in your system.</p>
        </div>
      </div>
