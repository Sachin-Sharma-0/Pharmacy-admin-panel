        ...
        <table className="min-w-full divide-y divide-gray-300">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Total Spent</th>
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {[
              { id: 1, name: 'John Doe', email: 'john.doe@example.com', phone: '(123) 456-7890', orders: 5, totalSpent: '₵1,245.99' },
              { id: 2, name: 'Jane Smith', email: 'jane.smith@example.com', phone: '(234) 567-8901', orders: 3, totalSpent: '₵825.50' },
              { id: 3, name: 'Robert Johnson', email: 'robert.j@example.com', phone: '(345) 678-9012', orders: 2, totalSpent: '₵349.99' },
              { id: 4, name: 'Emily Davis', email: 'emily.davis@example.com', phone: '(456) 789-0123', orders: 7, totalSpent: '₵1,845.00' },
              { id: 5, name: 'Michael Wilson', email: 'michael.w@example.com', phone: '(567) 890-1234', orders: 1, totalSpent: '₵199.99' },
            ].map((customer) => (
              <tr key={customer.id}>
                ...
                <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{customer.totalSpent}</td>
