        ...
        <table className="min-w-full divide-y divide-gray-300">
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {[
              ...
              { id: 3, name: 'Organic Apples', category: 'Food', price: '₵4.99', stock: 30, status: 'Low Stock' },
              { id: 4, name: 'Bestseller Novel', category: 'Books', price: '₵14.99', stock: 65, status: 'Active' },
              { id: 5, name: 'Smart Watch', category: 'Electronics', price: '₵199.99', stock: 15, status: 'Low Stock' },
            ].map((product) => (
              <tr key={product.id}>
                ...
                <td className="whitespace-nowrap px-3 py-4 text-sm">
                  <span className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${product.status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
                    {product.status}
                  </span>
                </td>
        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          ...
          <div>
            <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
              ...
              <a href="#" className="relative hidden items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 md:inline-flex">5</a>
