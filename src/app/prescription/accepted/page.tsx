...
// Sample prescription data with only Accepted status
const initialPrescriptions = [
  ...
  { id: 'PRE-008', name: 'Omeprazole 20mg', vendorId: 'V-456', status: 'Accepted', dateTime: '2023-10-08T09:20:00' },
  { id: 'PRE-010', name: 'Prednisone 10mg', vendorId: 'V-789', status: 'Accepted', dateTime: '2023-10-06T13:45:00' },
];

export default function AcceptedPrescriptionsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Accepted Prescriptions</h1>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="relative max-w-xs w-full">
          ...
          <input
            ...
            placeholder="Search accepted prescriptions..."
            value={searchQuery}
            ...
            {filteredPrescriptions.map((prescription) => (
              <tr key={prescription.id}>
                ...
                <td className="whitespace-nowrap px-3 py-4 text-sm">
                  <span className="inline-flex rounded-full px-2 text-xs font-semibold leading-5 bg-[#41AFFF]/20 text-[#41AFFF]">
                    {prescription.status}
                  </span>
                </td>
