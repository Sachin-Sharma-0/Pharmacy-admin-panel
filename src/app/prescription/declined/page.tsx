...
// Sample prescription data with only Declined status
const initialPrescriptions = [
  ...
  { id: 'PRE-009', name: 'Amlodipine 5mg', vendorId: 'V-123', status: 'Declined', dateTime: '2023-10-07T14:10:00' },
  { id: 'PRE-012', name: 'Hydrochlorothiazide 25mg', vendorId: 'V-789', status: 'Declined', dateTime: '2023-10-04T11:30:00' },
];

export default function DeclinedPrescriptionsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Declined Prescriptions</h1>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="relative max-w-xs w-full">
          ...
          <input
            ...
            placeholder="Search declined prescriptions..."
            value={searchQuery}
