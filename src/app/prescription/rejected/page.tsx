...
// Sample prescription data with only Rejected status
const initialPrescriptions = [
  ...
  { id: 'PRE-011', name: 'Losartan 50mg', vendorId: 'V-456', status: 'Rejected', dateTime: '2023-10-05T10:15:00' },
  { id: 'PRE-013', name: 'Gabapentin 300mg', vendorId: 'V-123', status: 'Rejected', dateTime: '2023-10-03T09:40:00' },
];

export default function RejectedPrescriptionsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Rejected Prescriptions</h1>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="relative max-w-xs w-full">
          ...
          <input
            ...
            placeholder="Search rejected prescriptions..."
            value={searchQuery}
