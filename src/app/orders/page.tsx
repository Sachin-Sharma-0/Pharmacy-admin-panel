      ...
      <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
        <table className="min-w-full divide-y divide-gray-300">
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {[
              { id: '#ORD-1234', customer: 'John Doe', date: 'May 15, 2023', total: '₵245.99', status: 'Delivered' },
              { id: '#ORD-1235', customer: 'Jane Smith', date: 'May 16, 2023', total: '₵125.50', status: 'Processing' },
              { id: '#ORD-1236', customer: 'Robert Johnson', date: 'May 16, 2023', total: '₵89.99', status: 'Shipped' },
              { id: '#ORD-1237', customer: 'Emily Davis', date: 'May 17, 2023', total: '₵345.00', status: 'Pending' },
              { id: '#ORD-1238', customer: 'Michael Wilson', date: 'May 17, 2023', total: '₵199.99', status: 'Cancelled' },
            ].map((order) => (
              <tr key={order.id}>
